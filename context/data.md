...
Source: Supervisor's CODEX HANDOFF 001 and approved DATA-001. Dataset V1 strategy: CONFIRMED; source inspection and selection: VERIFIED; three-image pilot generation: VERIFIED EXECUTION, NEEDS VISUAL REVIEW.
...
The earlier six-category, 72-pair preliminary plan is superseded for V1 by the Supervisor's three exact classes: `CrewCut`, `BobHair`, `LayeredHair`. The [DATA-001 record](../docs/data/DATA-001.md) pins `yikaiwang/FaceSketches-HairStyle40` at `45de974926fe64551fc2d0b80973335e20ca10e2`: its card declares Apache-2.0, its original photo folders each contain 30 decodable images, and a hand-reviewed provisional selection has ten per class (eight train and two validation identity groups). The source card names Hairstyle30k as upstream; it does not document individual photograph rights. The three TRAIN pilot generations completed in Kaggle, but their pixels and sidecars have not been reviewed. No generated counterpart has been accepted, so 48 train + 12 validation directional pairs remain a target, not an existing dataset.
