...
The Supervisor authorized System MVP work after EXP-001. Its implementation brief and acceptance criteria are pending clarification. Load-bearing implementation choices belong in `docs/specs/`; experiment evidence belongs in `docs/experiments/`.
