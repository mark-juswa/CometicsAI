...
Current task boundary: the approved System MVP is implemented locally with a clearly labeled MockEngine, Next.js frontend, and FastAPI backend. The real hairstyle dataset and LoRA remain NOT STARTED, and deployment has not begun. The exact calendar deadline is UNKNOWN.
