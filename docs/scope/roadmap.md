...
| 2 | FLUX.2 Klein free-GPU feasibility smoke test | IN PROGRESS | FP16 produced NaN loss; one controlled BF16 3-step probe and conditional 20-step confirmation are authorized. See [experiment record](../experiments/EXP-001.md). |
