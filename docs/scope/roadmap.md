...
| 2 | FLUX.2 Klein free-GPU feasibility smoke test | IN PROGRESS | Environment gate GREEN on T4 ×2; remaining model, edit, tiny training, reload, and compatibility stages not yet run. See [experiment record](../experiments/EXP-001.md). |
