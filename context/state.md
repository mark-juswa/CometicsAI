...
| Dataset | IN PROGRESS | DATA-001 has 30 selected originals with an 8/2 split per class and three completed V1/global pilot outputs. The Supervisor superseded the strict pilot stop with a practical review standard and authorized V1 generation for the remaining 27; the V1 handoff is prepared and locally checked. No official ACCEPT reviews, full generation, or directional pairs exist yet. Masked V2 is optional fallback only. See [active handoff](../docs/data/DATA-001-v1-bulk-handoff.md). |
