...
| 2 | FLUX.2 Klein free-GPU feasibility smoke test | BLOCKED | 20/20 steps and adapter reload/inference completed, but all losses were NaN; stopped at the structural numerical failure. See [experiment record](../experiments/EXP-001.md). |
