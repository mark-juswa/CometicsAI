...
| 2 | FLUX.2 Klein free-GPU feasibility smoke test | BLOCKED | Authorized as EXP-001; harness prepared, Kaggle access unavailable. See [experiment record](../experiments/EXP-001.md). |
