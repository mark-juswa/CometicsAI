...
| 2 | FLUX.2 Klein free-GPU feasibility smoke test | NOT STARTED | Separate authorization; verify actual GPU, model/edit path, compatible LoRA path, and limits before committing to training. |
